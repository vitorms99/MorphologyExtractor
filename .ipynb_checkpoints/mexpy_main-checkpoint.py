...
from mexpy.Utils_module import get_files_with_format, vary_galaxy_image, remove_central_region, recenter_image, extract_cutouts
    ...
    try:
        ...
        if user_inputs['measure_indexes']['Smoothness']:
            ...
            if user_inputs['S_barchi']:
                S_final, S_gal, S_noise = smoothness_calc.get_smoothness_barchi()
                result_row['S_b'] = S_gal
